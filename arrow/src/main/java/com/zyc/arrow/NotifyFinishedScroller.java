...
/**
 * 除了新增的mNotifier成员以及在computeScrollOffset()做出通知之外，其余是Scroller的整个的源代码。
 *
 * @author zeng_yong_chang@163.com
 */
public class NotifyFinishedScroller {
  ...
  private ScrollFinishedNotifier mNotifier;
  private int mMode;
  private int mStartX;
  private int mStartY;
  private int mFinalX;
   ...
   */
  public NotifyFinishedScroller(Context context) {
    this(context, null);
  }
   ...
   * (viscous)
   * interpolator will be used. "Flywheel" behavior will be in effect for apps targeting Honeycomb
   * or newer.
   */
  public NotifyFinishedScroller(Context context, Interpolator interpolator) {
   ...
   * Create a Scroller with the specified interpolator. If the interpolator is null, the default
   * (viscous)
   * interpolator will be used. Specify whether or not to support progressive "flywheel" behavior
   * in
   * flinging.
   */
  public NotifyFinishedScroller(Context context, Interpolator interpolator, boolean flywheel) {
    mFinished = true;
  ...
  public void setScrollFinishedNotifier(ScrollFinishedNotifier notifier) {
    mNotifier = notifier;
  }
  ...
  public interface ScrollFinishedNotifier {
